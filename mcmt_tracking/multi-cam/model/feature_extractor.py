...
from reidentification_util import TrackPlot
...
if __name__ == '__main__':
    ...
    recording = cv2.VideoWriter('../data/feature_extractor_output.avi', cv2.VideoWriter_fourcc(*'MJPG'), FPS, (FRAME_WIDTH, FRAME_HEIGHT))
